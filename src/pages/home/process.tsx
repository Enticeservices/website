        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-white border-t border-primary-dark/20 border-b">
            ...
            <div>
                <div className='w-10/12 mx-auto py-12 md:py-16 lg:py-20 xl:py-24'>
                    <span className='text-2xl title md:text-3xl lg:text-4xl 2xl:text-5xl  pr-6 md:pr-0 leading-snug max-w-4xl block text-primary-dark'>
                        How do we work?
                    </span>
                    <span className='text-sm block max-w-sm pt-5 text-primary-dark'>Through close collaboration, we create custom marketing solutions for exceptional results. Our team's expertise and innovation ensure your success.
                    </span>
                    <div className='grid text-primary-dark gap-10 pt-10'>
                        <ProcessPoint
                            index="01"
                            title="Research"
    ...
    return (
        <div className='space-y-4 flex gap-6'>
            <div className='basis-16'>
                <div className='w-14 h-14 rounded-full bg-primary-dark/30 flex items-center justify-center text-xl font-semibold'>
                    {index}
                </div>
            </div>
            <div className='max-w-sm'>
                <h3 className='text-lg font-semibold title'>{title}</h3>
                <p className='text-primary-dark/80 text-sm md:text-sm font-light leading-normal pt-2'>
                    {subtitle}
                </p>
            </div>
        </div>
