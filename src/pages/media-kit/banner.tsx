...
.cs-animated-bg .cs-bg1 {
  ...
  animation: cs-triangle 4s infinite;
...
.cs-animated-bg .cs-bg2 {
  ...
  animation: cs-heartbeat 4s infinite;
  background-position: 3em 1em, 1em 5em;
  z-index: 4;
}
...
.cs-animated-bg .cs-bg4 {
  color: var(--color-primary-dark);
  animation: cs-semicircle 4s infinite;
  ...
  return (
    ...
    >
      ...
      <div className='relative col-start-2 col-end-30 md:col-end-12 flex flex-col gap-2 md:gap-6 pb-6 lg:py-20 justify-end h-full z-50'>
        ...
        <span className='text-sm md:text-base lg:text-xl pr-6 md:pr-0 xl:text-xl text-white/90 leading-relaxed pt-2 block max-w-2xl'>
          Everything you need to know about our brand, including logos, guidelines, and press materials.
        </span>
      </div>
    </div>
  );
